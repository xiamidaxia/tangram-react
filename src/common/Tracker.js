...
Tracker._runFlush = function (options) {
  ...
  try {
    ...
    if (pendingComputations.length || afterFlushCallbacks.length) {
      ...
      // chance. We should flush again sooflush pushn.
...
Tracker.afterFlush = function (f) {
  ...
  // afterFlush callback will only exec next flush
  requireFlush();
};
...
export const autorun = Tracker.autorun
export const Dependency = Tracker.Dependency
